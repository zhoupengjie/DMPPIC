...
#ifdef MPPIC
    Info<< "Reading Duffusion coefficient\n" << endl;
        GV.duffusion_coefficient = kinematicCloud.particleProperties().subDict("constantProperties").get<scalar>("diffusion_coeff");

    Info<< "Duffusion coefficient: " << GV.duffusion_coefficient << endl;
#endif
